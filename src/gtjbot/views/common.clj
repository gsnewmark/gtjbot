(ns #^{:doc "Definitions of common page elements."} gtjbot.views.common
  (:use [noir.core :only [defpartial]]
        ...
        [appengine-magic.services.user :only [logout-url]]))
